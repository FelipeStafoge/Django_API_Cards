...
def last_three_cards_error(request):
    return render(request, 'last_three_cards_error/home.html', {'title': 'ERROR'})
...
def last_three_cards(request):
    ...
    if error == 0:
        ...
        return render(request, 'home/last_three_cards',{'title': 'Last three', 'first_card_value': first_card_value, 
    ...
    if error == 1:
        return render(request, 'home/last_three_cards_error.html', {'title': 'Error'})